...
export function SignupScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (!isValidDob(dob)) {
      setError("Use a valid date of birth in YYYY-MM-DD format.");
      return;
    }
    ...
    if (!idDocument) {
      setError("A valid ID document (JPG or PNG) is required.");
      return;
    }
        ...
        >
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.fieldsContainer}>
              ...
              <TextInput
                value={phone}
                onChangeText={(value) => setPhone(sanitizeDigits(value, 11))}
              ...
              <TextInput
                value={dob}
                onChangeText={(value) => setDob(normalizeDobInput(value))}
